...
- [ ] T044 `tests/e2e/sources.spec.ts`, `tests/cloud/source-failures.test.ts`, `docs/acceptance/sources.md`, `supabase/tests/b05.sql`, `supabase/migrations/20260907171424_b05.sql` — 验收多来源集成与失败恢复 → AC-002, AC-009
  - Batch: B05
  - Depends: T043

...
begin
  ...
  if source.revision <> p_expected_revision then raise exception using errcode = '40001', message = 'project revision conflict'; end if;
...
is '以所有者、修订和幂等回执复制项目，仅为新项目复制当前稿素材引用并创建独立首版快照';
